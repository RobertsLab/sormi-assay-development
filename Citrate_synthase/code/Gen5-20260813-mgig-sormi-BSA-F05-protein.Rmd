---
title: "Gen5-20260813-mgig-sormi-BSA-F05-protein"
author: "Sam White"
date: "2026-08-13"
output:
  github_document:
...
(Pacific oyster) SoRMI plate `F05`, 16 samples (`F05_01`-`F05_08`, ambient and
...
given Mean/SD/CV of 971.656/77.065/7.931 are exactly the mean/SD/CV of its
...
replicates -- e.g. `SPL16` / `F05_08_ambient`, where 2 of 3 wells read above
the top standard -- has an undefined (`NA`) concentration CV and is treated
as failing QC, consistent with the source file itself being unable to
compute a CV there either (`?????`).
...
range are flagged as extrapolated (e.g. `F05_08_ambient` read above the top
standard on 2 of its 3 wells and was excluded above on CV grounds already,
since only 1 of its wells had a defined, non-censored concentration).
