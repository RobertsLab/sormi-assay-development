...
groupValues = activeGroupCol === null
  ? []
  : [...new Set(selectionRows.map(d => d[activeGroupCol]).filter(nonEmptyString))].sort(naturalCompare)
...
filtered = selectionRows.filter(d =>
  ...
  (activeGroupCol === null || nonEmptyString(d[activeGroupCol])) &&
