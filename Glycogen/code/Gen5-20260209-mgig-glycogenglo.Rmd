...
Sample C7 is out of the standard curve range. This sample was re-run with further dilutions on 20260218 (see Gen5-20260218-mgig-glycogenglo.md).

This experiment is a re-run of 20260206 (Gen5-20260206-mgig-glycogenglo.md). A re-run was performed because the standard curve values on 20260206 were significantly higher than expected, and it was unknown if this difference was due to expected variation or some error in how the assay was run. This re-run had very similar standard curve values, suggesting that this difference in standard curve values is within the range of expected variation. Sample glycogen and glucose values from both assays are fairly similar.
