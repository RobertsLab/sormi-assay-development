...
#A2
# Get unique dilution factors
A2_unique_dilution_factors <- unique(glyc_A2_dilutions)

# Calculate mean and SE for each dilution factor across replicates
glyc_A2_mean_lum <- numeric(length(A2_unique_dilution_factors))
glyc_A2_se_lum <- numeric(length(A2_unique_dilution_factors))
glyc_A2_mean_conc <- numeric(length(A2_unique_dilution_factors))

for (i in 1:length(A2_unique_dilution_factors)) {
  df_val <- A2_unique_dilution_factors[i]
  # Get luminescence values for this dilution factor from both rows
  glyc_A2_lum_values <- c(glyc_A2_luminescence[glyc_A2_dilutions == df_val])
...
# Get unique dilution factors
A3_unique_dilution_factors <- unique(glyc_A3_dilutions)

# Calculate mean and SE for each dilution factor across replicates
glyc_A3_mean_lum <- numeric(length(A3_unique_dilution_factors))
glyc_A3_se_lum <- numeric(length(A3_unique_dilution_factors))
glyc_A3_mean_conc <- numeric(length(A3_unique_dilution_factors))

for (i in 1:length(A3_unique_dilution_factors)) {
  df_val <- A3_unique_dilution_factors[i]
  # Get luminescence values for this dilution factor from both rows
  glyc_A3_lum_values <- c(glyc_A3_luminescence[glyc_A3_dilutions == df_val])
...
# Get unique dilution factors
A4_unique_dilution_factors <- unique(glyc_A4_dilutions)

# Calculate mean and SE for each dilution factor across replicates
glyc_A4_mean_lum <- numeric(length(A4_unique_dilution_factors))
glyc_A4_se_lum <- numeric(length(A4_unique_dilution_factors))
glyc_A4_mean_conc <- numeric(length(A4_unique_dilution_factors))

for (i in 1:length(A4_unique_dilution_factors)) {
  df_val <- A4_unique_dilution_factors[i]
  # Get luminescence values for this dilution factor from both rows
  glyc_A4_lum_values <- c(glyc_A4_luminescence[glyc_A4_dilutions == df_val])
...
# Get unique dilution factors
A5_unique_dilution_factors <- unique(glyc_A5_dilutions)

# Calculate mean and SE for each dilution factor across replicates
glyc_A5_mean_lum <- numeric(length(A5_unique_dilution_factors))
glyc_A5_se_lum <- numeric(length(A5_unique_dilution_factors))
glyc_A5_mean_conc <- numeric(length(A5_unique_dilution_factors))

for (i in 1:length(A5_unique_dilution_factors)) {
  df_val <- A5_unique_dilution_factors[i]
  # Get luminescence values for this dilution factor from both rows
  glyc_A5_lum_values <- c(glyc_A5_luminescence[glyc_A5_dilutions == df_val])
