...
All samples were out of the standard curve range. Samples A1-A5 were re-run on 20260126 (df.2 and 4) but were still out of the range. Re-running A1-A5 on 20260130 (Gen5-20260130-mgig-glycogenglo.md) with 20 and 100 fold dilutions brought samples within the standard curve range. Samples A6-B2 were re-run with df.20 on 20260204 (Gen5-20260204-mgig-glycogenglo.md), and were within standard curve range.
