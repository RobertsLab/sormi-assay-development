...
for (i in 1:length(A6_unique_dilution_factors)) {
...
for (i in 1:length(A7_unique_dilution_factors)) {
...
for (i in 1:length(A8_unique_dilution_factors)) {
...
for (i in 1:length(B1_unique_dilution_factors)) {
...
for (i in 1:length(B2_unique_dilution_factors)) {
