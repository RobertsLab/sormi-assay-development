...
All samples were out of the standard curve range. Samples A1-A5 were on
20260130 with 20 and 100 fold dilutions
(Gen5-20260130-mgig-glycogenglo.md), and were within the standard curve
range.

``` r
tab <- matrix(c(as.numeric(weights[1,2]), glyc_A1_dilution2, glyc_A1_mean_conc2, glu_A1_mean_conc2, (glyc_A1_mean_conc2-glu_A1_mean_conc2), ((glyc_A1_mean_conc2-glu_A1_mean_conc2)*(glyc_A1_dilution2/as.numeric(weights[1,2]))), 
                as.numeric(weights[2,2]), glyc_A2_dilution2, glyc_A2_mean_conc2, glu_A2_mean_conc2, (glyc_A2_mean_conc2-glu_A2_mean_conc2), ((glyc_A2_mean_conc2-glu_A2_mean_conc2)*(glyc_A2_dilution2/as.numeric(weights[2,2]))),
                as.numeric(weights[3,2]), glyc_A3_dilution2, glyc_A3_mean_conc2, glu_A3_mean_conc2, (glyc_A3_mean_conc2-glu_A3_mean_conc2), ((glyc_A3_mean_conc2-glu_A3_mean_conc2)*(glyc_A3_dilution2/as.numeric(weights[3,2]))), 
                as.numeric(weights[4,2]), glyc_A4_dilution2, glyc_A4_mean_conc2, glu_A4_mean_conc2, (glyc_A4_mean_conc2-glu_A4_mean_conc2), ((glyc_A4_mean_conc2-glu_A4_mean_conc2)*(glyc_A4_dilution2/as.numeric(weights[4,2]))),
                as.numeric(weights[5,2]), glyc_A5_dilution2, glyc_A5_mean_conc2, glu_A5_mean_conc2, (glyc_A5_mean_conc2-glu_A5_mean_conc2), ((glyc_A5_mean_conc2-glu_A5_mean_conc2)*(glyc_A5_dilution2/as.numeric(weights[5,2]))),
                as.numeric(weights[1,2]), glyc_A1_dilution4, glyc_A1_mean_conc4, glu_A1_mean_conc4, (glyc_A1_mean_conc4-glu_A1_mean_conc4), ((glyc_A1_mean_conc4-glu_A1_mean_conc4)*(glyc_A1_dilution4/as.numeric(weights[1,2]))), 
                as.numeric(weights[2,2]), glyc_A2_dilution4, glyc_A2_mean_conc4, glu_A2_mean_conc4, (glyc_A2_mean_conc4-glu_A2_mean_conc4), ((glyc_A2_mean_conc4-glu_A2_mean_conc4)*(glyc_A2_dilution4/as.numeric(weights[2,2]))),
                as.numeric(weights[3,2]), glyc_A3_dilution4, glyc_A3_mean_conc4, glu_A3_mean_conc4, (glyc_A3_mean_conc4-glu_A3_mean_conc4), ((glyc_A3_mean_conc4-glu_A3_mean_conc4)*(glyc_A3_dilution4/as.numeric(weights[3,2]))), 
                as.numeric(weights[4,2]), glyc_A4_dilution4, glyc_A4_mean_conc4, glu_A4_mean_conc4, (glyc_A4_mean_conc4-glu_A4_mean_conc4), ((glyc_A4_mean_conc4-glu_A4_mean_conc4)*(glyc_A4_dilution4/as.numeric(weights[4,2]))),
                as.numeric(weights[5,2]), glyc_A5_dilution4, glyc_A5_mean_conc4, glu_A5_mean_conc4, (glyc_A5_mean_conc4-glu_A5_mean_conc4), ((glyc_A5_mean_conc4-glu_A5_mean_conc4)*(glyc_A5_dilution4/as.numeric(weights[5,2])))
                ), ncol=6, byrow=TRUE)

colnames(tab) <- c('Weight (mg)', 'df', 'Glycogen (ug/uL)', 'Glucose (uM)', 'Glycogen-Glucose (ug/uL)', '(Glycogen-Glucose)*df/weight (ug/uL/mg)')
rownames(tab) <- c('A1.df2','A2.df2','A3.df2','A4.df2','A5.df2','A1.df4','A2.df4','A3.df4','A4.df4','A5.df4')
tab <- as.table(tab)
tab
```

           Weight (mg)        df Glycogen (ug/uL) Glucose (uM)
    A1.df2   25.000000  2.000000        26.700774     1.787010
    A2.df2   50.000000  2.000000        27.495294     1.372115
    A3.df2   14.000000  2.000000        23.829471     1.187920
    A4.df2   21.000000  2.000000        27.827525     1.105359
    A5.df2   24.000000  2.000000        26.862267     1.711242
    A1.df4   25.000000  4.000000        28.270459     1.338411
    A2.df4   50.000000  4.000000        27.220386     1.135143
    A3.df4   14.000000  4.000000        13.323817     1.102746
    A4.df4   21.000000  4.000000        24.842807     1.076358
    A5.df4   24.000000  4.000000        28.893376     1.414702
           Glycogen-Glucose (ug/uL) (Glycogen-Glucose)*df/weight (ug/uL/mg)
    A1.df2                24.913764                                1.993101
    A2.df2                26.123179                                1.044927
    A3.df2                22.641552                                3.234507
    A4.df2                26.722166                                2.544968
    A5.df2                25.151025                                2.095919
    A1.df4                26.932048                                4.309128
    A2.df4                26.085243                                2.086819
    A3.df4                12.221071                                3.491735
    A4.df4                23.766449                                4.526943
    A5.df4                27.478675                                4.579779
