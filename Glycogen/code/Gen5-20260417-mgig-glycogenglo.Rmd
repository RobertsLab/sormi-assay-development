---
title: "Gen5-20260417-mgig-glycogenglo"
...
```{r, normalize calculated glycogen to sample weight}
#plate1
...
```{r add 0.0A* glucose to standard curve, include=TRUE}
# Create sample data frame
...
```{r add 0.0B* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 0.0C* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 0.0D* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 0.0E* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 0.0F* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 0.0G* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 0.0H* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 0.0I* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 0.0J* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.0A* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.0B* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.0C* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.0D* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.0E* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.0F* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
glu_48.0F_mean_conc
```
```{r add 48.0G* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.0H* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.0I* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.0J* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.2A* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.2B* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.2C* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.2D* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.2E* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.2F* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.2G* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.2H* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.2I* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.2J* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.7A* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.7B* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.7C* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.7D* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.7E* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.7F* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.7G* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.7H* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.7I* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
```{r add 48.7J* glucose to standard curve, include=TRUE}
# Create sample data frame
# Calculate glucose concentration from luminescence using the standard curve equation
# Rearranging y = mx + b to solve for x: x = (y - b) / m
...
### Sample glucose table

```{r, normalize calculated glucose to sample weight}
#plate1
...
Note: the ‘glycogen’ readout includes background glucose - the ‘Glycogen-Glucose’ number is a more accurate measurement of glycogen levels, as this removes the contribution of background glucose
