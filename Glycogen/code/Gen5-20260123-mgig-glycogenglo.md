...
re-run on 20260126 (Gen5-20260126-mgig-glycogenglo.md) with 2 and 4 fold
dilutions, but were still out of the range. Re-running A1-A5 on 20260130
(Gen5-20260130-mgig-glycogenglo.md) with 20 and 100 fold dilutions
brought samples within the standard curve range. Samples A6-B2 were
re-run with df.20 on 20260204 (Gen5-20260204-mgig-glycogenglo.md), and
were within standard curve range.
...
tab <- matrix(c(as.numeric(weights[1,2]), glyc_A1_dilution, glyc_A1_mean_conc, glu_A1_mean_conc, (glyc_A1_mean_conc-glu_A1_mean_conc), ((glyc_A1_mean_conc-glu_A1_mean_conc)*(glyc_A1_dilution/as.numeric(weights[1,2]))), 
                as.numeric(weights[2,2]), glyc_A2_dilution, glyc_A2_mean_conc, glu_A2_mean_conc, (glyc_A2_mean_conc-glu_A2_mean_conc), ((glyc_A2_mean_conc-glu_A2_mean_conc)*(glyc_A2_dilution/as.numeric(weights[2,2]))),
                as.numeric(weights[3,2]), glyc_A3_dilution, glyc_A3_mean_conc, glu_A3_mean_conc, (glyc_A3_mean_conc-glu_A3_mean_conc), ((glyc_A3_mean_conc-glu_A3_mean_conc)*(glyc_A3_dilution/as.numeric(weights[3,2]))), 
                as.numeric(weights[4,2]), glyc_A4_dilution, glyc_A4_mean_conc, glu_A4_mean_conc, (glyc_A4_mean_conc-glu_A4_mean_conc), ((glyc_A4_mean_conc-glu_A4_mean_conc)*(glyc_A4_dilution/as.numeric(weights[4,2]))),
                as.numeric(weights[5,2]), glyc_A5_dilution, glyc_A5_mean_conc, glu_A5_mean_conc, (glyc_A5_mean_conc-glu_A5_mean_conc), ((glyc_A5_mean_conc-glu_A5_mean_conc)*(glyc_A5_dilution/as.numeric(weights[5,2]))), 
                as.numeric(weights[6,2]), glyc_A6_dilution, glyc_A6_mean_conc, glu_A6_mean_conc, (glyc_A6_mean_conc-glu_A6_mean_conc), ((glyc_A6_mean_conc-glu_A6_mean_conc)*(glyc_A6_dilution/as.numeric(weights[6,2]))),
...
```
    ...
    A1  25.0000000  2.0000000       24.1056000    2.8706579
    A2  50.0000000  2.0000000       24.2468796    2.8966916
    A3  14.0000000  2.0000000       24.2804639    1.7790617
    A4  21.0000000  2.0000000       24.9748395    1.7040845
    A5  24.0000000  2.0000000       23.2666145    2.0943307
    A6  25.0000000  2.0000000       25.4556306    3.4043502
    A7  17.0000000  2.0000000       23.1843190    1.8334723
    A8  12.0000000  2.0000000       24.3520915    1.8600268
    B1  20.0000000  2.0000000       24.9374171    1.8272242
    B2  31.0000000  2.0000000       24.9602205    1.8483116
       Glycogen-Glucose (ug/uL) (Glycogen-Glucose)*df/weight (ug/uL/mg)
    A1               21.2349421                               1.6987954
    A2               21.3501880                               0.8540075
    A3               22.5014022                               3.2144860
    A4               23.2707551                               2.2162624
    A5               21.1722838                               1.7643570
    A6               22.0512804                               1.7641024
    A7               21.3508467                               2.5118643
    A8               22.4920647                               3.7486775
    B1               23.1101929                               2.3110193
    B2               23.1119089                               1.4910909
