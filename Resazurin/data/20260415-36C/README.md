`sormi-assay-development/Resazurin/data/20260415-36C`
...
- [`layout.csv`](https://github.com/RobertsLab/sormi-assay-development/blob/main/Resazurin/data/20260415-36C/layout.csv): This is a comma-delimited plate layout file containing various metadata which is automatically parsed/processed to create the data dashboard.
